          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 pt-8 max-w-md mx-auto lg:mx-0">
            {[
              ...
              <div key={idx} className="group reveal" style={{ transitionDelay: `${400 + (idx * 100)}ms` }}>
                ...
                <h4 className="text-white uppercase text-[8px] sm:text-[10px] tracking-widest mt-2 font-bold group-hover:tracking-[0.3em] transition-all duration-500">{item.label}</h4>
              </div>
            ))}
          </div>
        </div>
