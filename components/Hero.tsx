    ...
    <section id="home" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#262626] pt-32 md:pt-40">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <div className="overflow-hidden mb-6 flex justify-center">
          <div className="animate-slide-up inline-block px-6 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm shadow-[0_0_20px_rgba(0,155,219,0.15)] hover:bg-white/10 transition-colors duration-500">
        ...
        <div className="mt-16 sm:mt-24 flex flex-col items-center gap-3 opacity-0 animate-fade-in animation-delay-2000">
